...
function main() {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      "3. End the session or use the seeded report URL to show the Agent Performance Report.",
      "4. Open the Mediator Agent Review and export JSON.",
...
function demoLines(demo) {
  ...
  return [
    ...
    `- Mediator Agent Review: http://localhost:3000/rooms/${demo.roomId}/agents/mediator_v1`,
