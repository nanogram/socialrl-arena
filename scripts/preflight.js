...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ...
    ["src/core.js", core, ["activePolicyOverrides", "advice_spiral", "agentSelectionRules", "applyRoutingPolicy", "buildDecisionReview", "buildModelRoutingPlan", "buildModelRoutingSummary", "buildRoutingRecommendationReason", "casual_hangout", "chaotic", "debate_prep", "decisionReview", "detectQuietParticipant", "emotionallySensitive", "fandom_rp", "game_night", "generateImprovedPolicy", "modelRoutingSummary", "normalizeReplyToMessageId", "pickRoutedWinner", "refreshLatestReport", "replyTargetRate", "replyToMessageId", "routingScores", "roomsTracked", "stalled", "support_checkin", "targetedDecisionRate", "targetUserForDecision", "targetUserCounts", "p99FirstTokenLatencyMs", "p99FullResponseLatencyMs", "llmErrorRate", "routeNextAgentCounts"]],
