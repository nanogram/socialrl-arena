...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ["public/index.html", html, ["debugToggleButton", "displayNameInput", "normalChatBar", "normalSessionFeedback", "replyPreview", "participants", "policies", "memoryLedger", "moodTimeline", "routingDecisions"]],
    ["public/app.js", app, ["AI agent", "agentSelectionRules", "basePersonality", "candidateScores", "comparisonColumn", "copyInviteLink", "humanMomentumDirection", "landing", "live-telemetry-card", "model-step-tags", "normalAgentOptions", "reply_to_message_id", "renderAgentStats", "renderAutomaticReception", "renderDecisionReview", "renderEvidenceManifest", "renderExampleContext", "renderFailureModeCard", "renderLandingPage", "renderLiveTelemetry", "renderModelStepTags", "renderModelRoutingSummary", "renderNormalChatBar", "renderNormalSessionFeedback", "renderParticipants", "renderPolicies", "renderRoomMemoryLedger", "renderRoomMoodTimeline", "renderSocialIntelligenceReview", "renderReplyContext", "renderReplyPreview", "renderRoutingDecisions", "renderRoutingFeedbackVotes", "renderRuleAdjustments", "renderRunArchive", "renderSystemPerformance", "renderThinkingState", "targetUser", "socialrl_debug_panel", "socialrl_display_name"]],
    ...
    ["src/core.js", core, ["activePolicyOverrides", "advice_spiral", "agentSelectionRules", "applyRoutingPolicy", "archiveCurrentRun", "automaticReception", "buildAutomaticReception", "buildDecisionReview", "buildEvidenceManifest", "buildModelRoutingPlan", "buildModelRoutingSummary", "buildRoomMemoryLedger", "buildRoomMoodTimeline", "buildRoutingRecommendationReason", "buildSocialIntelligenceReview", "casual_hangout", "chaotic", "debate_prep", "decisionReview", "detectQuietParticipant", "emotionallySensitive", "evidenceManifest", "exportRunSnapshot", "first_token_latency_ms", "fandom_rp", "game_night", "generateImprovedPolicy", "humanConversationDelta", "humanConversationLift", "humanMomentumDirection", "latency_ms", "Message feedback can only be added to AI messages", "memory_miss", "modelRoutingSummary", "normalizeReplyToMessageId", "pickRoutedWinner", "pizza-themed side quest", "refreshLatestReport", "replyTargetRate", "replyToMessageId", "roomMemoryLedger", "roomMoodTimeline", "routingScores", "runHistory", "senderId", "roomsTracked", "stalled", "support_checkin", "targetedDecisionRate", "targetUserForDecision", "targetUserCounts", "token_count", "p99FirstTokenLatencyMs", "p99FullResponseLatencyMs", "llmErrorRate", "routeNextAgentCounts"]],
    ["src/storage.js", storage, ["decision_review", "social_intelligence_review", "automatic_reception", "evidence_manifest", "room_memory_ledger", "room_mood_timeline", "model_routing", "model_routing_summary", "firstTokenLatencyMs", "first_token_latency_ms", "insertRoutingDecisions", "insertReportJobs", "routing_decisions", "report_jobs"]],
    ["db/schema.sql", schema, ["create table if not exists routing_decisions", "create table if not exists report_jobs", "decision_review", "social_intelligence_review", "automatic_reception", "evidence_manifest", "room_memory_ledger", "room_mood_timeline", "model_routing", "model_routing_summary", "first_token_latency_ms"]],
    ...
    ["src/prompts.js", fs.readFileSync("src/prompts.js", "utf8"), ["buildReportEvalInputs", "fullTranscript", "messageLatency", "roomMemoryLedger", "roomMoodTimeline", "socialIntelligenceReview", "evidenceManifest", "emotionally_sensitive", "stalled", "chaotic"]],
    [".env.example", env, ["OPENAI_DECISION_MODEL", "OPENAI_ROUTER_MODEL", "OPENAI_MESSAGE_MODEL", "OPENAI_REPORT_MODEL"]],
    ["README.md", readme, ["Demo Video", "socialrl-demo.gif", "flowchart LR", "Report queue + worker", "Per-stage model routing evidence", "Transcript/report JSON export", "Synthetic WebSocket load test", "Normalized messages, decisions, routing, feedback, reports"]],
