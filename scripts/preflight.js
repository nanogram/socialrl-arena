...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ...
    ["public/app.js", app, ["AI agent", "agentSelectionRules", "basePersonality", "candidateScores", "comparisonColumn", "copyInviteLink", "humanMomentumDirection", "landing", "live-telemetry-card", "model-step-tags", "normalAgentOptions", "reply_to_message_id", "renderAgentStats", "renderDecisionReview", "renderEvidenceManifest", "renderExampleContext", "renderFailureModeCard", "renderLandingPage", "renderLiveTelemetry", "renderModelStepTags", "renderModelRoutingSummary", "renderNormalChatBar", "renderNormalSessionFeedback", "renderParticipants", "renderPolicies", "renderReplyContext", "renderReplyPreview", "renderRoutingDecisions", "renderRoutingFeedbackVotes", "renderRuleAdjustments", "renderRunArchive", "renderSystemPerformance", "renderThinkingState", "targetUser", "socialrl_debug_panel", "socialrl_display_name"]],
