...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ...
    ["src/core.js", core, ["activePolicyOverrides", "agentSelectionRules", "applyRoutingPolicy", "generateImprovedPolicy", "pickRoutedWinner", "refreshLatestReport", "routingScores", "p99FirstTokenLatencyMs", "p99FullResponseLatencyMs", "llmErrorRate", "routeNextAgentCounts"]],
