...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ...
    ["src/core.js", core, ["activePolicyOverrides", "advice_spiral", "agentSelectionRules", "applyRoutingPolicy", "archiveCurrentRun", "buildDecisionReview", "buildModelRoutingPlan", "buildModelRoutingSummary", "buildRoutingRecommendationReason", "casual_hangout", "chaotic", "debate_prep", "decisionReview", "detectQuietParticipant", "emotionallySensitive", "exportRunSnapshot", "fandom_rp", "game_night", "generateImprovedPolicy", "humanConversationDelta", "humanConversationLift", "humanMomentumDirection", "modelRoutingSummary", "normalizeReplyToMessageId", "pickRoutedWinner", "refreshLatestReport", "replyTargetRate", "replyToMessageId", "routingScores", "runHistory", "senderId", "roomsTracked", "stalled", "support_checkin", "targetedDecisionRate", "targetUserForDecision", "targetUserCounts", "p99FirstTokenLatencyMs", "p99FullResponseLatencyMs", "llmErrorRate", "routeNextAgentCounts"]],
