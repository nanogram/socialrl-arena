...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ...
    ["public/app.js", app, ["AI Shape", "agentSelectionRules", "basePersonality", "candidateScores", "comparisonColumn", "copyInviteLink", "landing", "normalAgentOptions", "renderDecisionReview", "renderExampleContext", "renderFailureModeCard", "renderLandingPage", "renderModelRoutingSummary", "renderNormalChatBar", "renderNormalSessionFeedback", "renderParticipants", "renderPolicies", "renderRoutingDecisions", "renderRoutingFeedbackVotes", "renderRuleAdjustments", "renderShapeStats", "renderSystemPerformance", "renderThinkingState", "targetUser", "socialrl_debug_panel", "socialrl_display_name"]],
    ...
    ["src/core.js", core, ["activePolicyOverrides", "agentSelectionRules", "applyRoutingPolicy", "buildDecisionReview", "buildModelRoutingPlan", "buildModelRoutingSummary", "buildRoutingRecommendationReason", "chaotic", "decisionReview", "detectQuietParticipant", "emotionallySensitive", "generateImprovedPolicy", "modelRoutingSummary", "pickRoutedWinner", "refreshLatestReport", "routingScores", "roomsTracked", "stalled", "targetUserForDecision", "p99FirstTokenLatencyMs", "p99FullResponseLatencyMs", "llmErrorRate", "routeNextAgentCounts"]],
