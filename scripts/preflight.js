...
function checkSpecMarkers() {
  ...
  for (const [file, body, markers] of [
    ...
    ["README.md", readme, ["Demo Video", "<video controls", "socialrl-demo.mp4", "flowchart LR", "Report queue + worker", "Per-stage model routing evidence", "Transcript/report JSON export", "Synthetic WebSocket load test", "Normalized messages, decisions, routing, feedback, reports", "Final Submission Status", "LIVE_DEMO_URL", "GITHUB_REPO_URL", "DEMO_VIDEO_URL"]],
