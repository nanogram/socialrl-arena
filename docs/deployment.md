...
With Postgres, the app writes both full room snapshots and normalized rows for messages, first-token/full-response latency, agent decisions, routing decisions, report jobs, feedback, and generated reports.
